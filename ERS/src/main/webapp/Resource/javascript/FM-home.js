window.onload = function(){
    getRequests();
    document.getElementById("filterSubmit").addEventListener('click', filterRequests);
}
function getRequests(){
    ...
    xhttp.open('POST', `http://localhost:9001/ERS/json/allrequests`);
    xhttp.send();
}
...
function filterRequests(){
    ...
    xhttp.open('POST', `http://localhost:9001/ERS/json/filterrequests`);
